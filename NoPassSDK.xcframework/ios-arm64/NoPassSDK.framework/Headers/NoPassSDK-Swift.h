...
#ifndef NOPASSSDK_SWIFT_H
#define NOPASSSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NoPassSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic, copy) NSString * _Nullable userseed;
@end


SWIFT_CLASS_NAMED("AuthHistory")
@interface AuthHistory : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface AuthHistory (SWIFT_EXTENSION(NoPassSDK))
@property (nonatomic, copy) NSDate * _Nullable authDate;
@property (nonatomic, copy) NSString * _Nullable hex;
@property (nonatomic) BOOL isSuccesAuth;
@property (nonatomic, copy) NSString * _Nullable portalUrl;
@property (nonatomic, copy) NSString * _Nullable userCode;
@property (nonatomic, copy) NSString * _Nullable userName;
@end
...
SWIFT_CLASS("_TtC9NoPassSDK14NetworkManager")
...
SWIFT_CLASS("_TtC9NoPassSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(NoPassSDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(NoPassSDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(NoPassSDK)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(NoPassSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(NoPassSDK)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC9NoPassSDK12TaskDelegate")
